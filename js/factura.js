...
// Cambiar el nombre de la función en factura.js
async function exportarFacturaWord(pedido) {
    if (!pedido) return;
    ...
    try {
        ...
        // Modify the return statement in exportarFacturaWord
        ...
        a.href = url;
        a.download = `Factura_${pedido.nombreCliente || 'Cliente'}_${new Date().toLocaleDateString().replace(/\//g, '-')}.docx`;
        a.click();
...
window.exportarFacturaWord = exportarFacturaWord;
